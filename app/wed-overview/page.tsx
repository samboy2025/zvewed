    ...
    <div className="min-h-screen">
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 max-w-6xl mx-auto">
            <div className="text-center">
              ...
              <div className="text-xl text-gray-300 mb-2">Successful Events</div>
              <div className="text-sm text-gray-500">2022 - 2024</div>
            </div>
            <div className="text-center">
              <div className="text-5xl font-bold text-red-500 mb-4">570+</div>
              <div className="text-xl text-gray-300 mb-2">Total Participants</div>
            ...
            <div className="text-center">
              <div className="text-5xl font-bold text-red-500 mb-4">₦50M+</div>
              <div className="text-xl text-gray-300 mb-2">Investments Facilitated</div>
              <div className="text-sm text-gray-500">Through networking</div>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Explore the evolution of World Entrepreneurship Day from its inception to the upcoming WED 3.0
            </p>
          </div>
      ...
      <section className="py-24 gradient-red text-white">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-4xl font-bold mb-8">Join the WED Movement</h2>
          <p className="text-xl mb-12 max-w-3xl mx-auto font-light leading-relaxed">
            Be part of the next chapter in our entrepreneurial journey. Register for WED 3.0 and help us create a
